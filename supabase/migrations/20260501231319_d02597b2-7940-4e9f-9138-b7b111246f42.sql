...
begin
  ...
  -- Removido 'boleto' até existir o método na UI/enum.
  ...
  -- Bug fix: ignorar produtos sem controle de estoque (stock IS NULL),
  -- evitando que `pr.stock - qty` propague NULL e zere/sobrescreva o valor.
