-- Audit pass — fixes 28/04/2026
-- 1) Reseed/garante site_settings (404 PGRST205 persistente em produção).
-- 2) RPC create_order com SELECT ... FOR UPDATE para evitar race de estoque.
...
begin
  ...
  loop
    ...
    -- FOR UPDATE: trava a linha do produto até o commit, eliminando race
    -- entre dois pedidos simultâneos disputando o último item de estoque.
