...
export default function Catalog() {
  ...
  return (
    <>
      ...
      {/* Sections */}
      <section className="relative pt-2 md:pt-3 pb-2 scroll-mt-32">
        <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="flex flex-col flex-1 px-3 pt-2.5 pb-3 sm:px-3.5 sm:pt-3 sm:pb-4">
                ...
                <button
                  ...
                  className="mt-auto pt-3 inline-flex items-center justify-center gap-1 h-9 sm:h-10 w-full rounded-full bg-secondary text-secondary-foreground text-sm font-semibold hover:bg-secondary/90 active:scale-[0.98] transition-all shadow-sm shadow-secondary/30 disabled:opacity-40 disabled:cursor-not-allowed disabled:bg-muted disabled:text-muted-foreground disabled:shadow-none box-content"
                >
