...
export default function About() {
  useSEO({
    title: "Sobre a Royal Vita — quem somos e como trabalhamos",
    description:
      "Conheça a Royal Vita: curadoria de farmacêuticos importados, atendimento humano e entrega para todo o Brasil com pagamento seguro.",
    type: "website",
  });
  ...
  return (
    <div className="container max-w-3xl mx-auto px-4 py-12 md:py-16">
      ...
      <p className="mt-4 text-base md:text-lg text-muted-foreground leading-relaxed">
        A Royal Vita nasceu para tornar o acesso a produtos farmacêuticos importados
